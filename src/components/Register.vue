...
<template>
    <div id="container" class="flex min-h-screen">
        <aside class="flex flex-col p-8 w-[40%]">
            ...
            <p class="mt-2 text-sm">Đăng ký để tiếp tục</p>
            ...
            <form class="mt-8" @submit.prevent="register()">
                ...
                <!-- Link Start! -->
                <button class="bg-[var(--primary-color)] mt-4 rounded-lg w-full h-12 font-bold text-lg text-white" type="submit">ĐĂNG KÝ</button>
            </form>
            ...
            <div class="flex justify-center items-center mt-auto">
                <RouterLink to="/login">Bạn đã có tài khoản rồi?</RouterLink>
            </div>
        </aside>
